...
global.IS_NODE = global.ISNODE = true;

exports.tinyrequire = window.tinyrequire = {
  modules : {},
  queued : {},
  acceptqueue : {},
  loaded : {},
  ...
  load : function(name) {
    ...
    var define = window.define = function define(deps, callback) {
    ...
    var timer = window.setInterval(function() {
      if (Object.keys(this2.queued).length == 0) {
        ...
        for (var i=0; i<deps.length; i++) {
          deps[i] = deps[i] in this2.modules ? this2.modules[deps[i]].exports : undefined;
        }
