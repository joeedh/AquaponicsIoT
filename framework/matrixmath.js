...
define([
  ...
  var exports = _matrixmath = {};
  var Vector2, Vector3, Vector4; //generated vectormath feeds these to matrixmath, to avoid module cycle

  var lookat_cache_vs3;
  var lookat_cache_vs4;
  var quattomatrix_cache;
  ...
  var Matrix4 = exports.Matrix4 = class Matrix4 {
    ...
    static is(matrix) {
      return matrix.constructor.name == "Matrix4";
    }
    ...
    lookat(pos, target, up) {
      ...
      //tmat.translate(pos[0], pos[1], pos[2]);;
  ...
  exports.initVector = function(cls, size) {
    if (size == 2) {
      Vector2 = cls;
    } else if (size == 3) {
      Vector3 = cls;

      cls.prototype.multVecMatrix = function multVecMatrix(matrix, ignore_w) {
      ...
      cls.prototype.cross = function cross(v) {
      ...
      cls.prototype.mulVecQuat = function mulVecQuat(q) {
      ...
      lookat_cache_vs3 = util.cachering.fromConstructor(cls, 128);
    } else if (size == 4) {
      Vector4 = cls;

      cls.prototype.multVecMatrix = function multVecMatrix(matrix) {
        var x=this[0];
        var y=this[1];
        var z=this[2];
        var w=this[3];
      ...
      lookat_cache_vs4 = util.cachering.fromConstructor(cls, 128);
    }
  }

  var Quat = exports.Quat = class Quat extends Array {
    constructor(b) {
      super();
  ...
  quattomatrix_cache = util.cachering.fromConstructor(Matrix4, 32);
